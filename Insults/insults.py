...
if __name__ == "__main__":
	competition_argsets = (
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final6.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","1e-7",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final7.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","1e-4",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final11.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","1e-6",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final12.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","3e-7",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final13.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","1e-7",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final14.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","1e-4",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final15.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","3e-5",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final16.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","1e-5",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final17.csv'),
		'--no_score'],
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final18.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","1e-6",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final19.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","3e-7",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final20.csv'),
		'--no_score'],
		[
		"--tune",
		"--sgd_alpha","1e-7",
		...
		"--trainfile",DataFile('Inputs',"fulltrain.csv"),
		"--testfile",DataFile('Inputs',"final.csv"),
		'--predictions',DataFile('Final','final21.csv'),
		'--no_score'],
		)
